...
- fix: lowercase-underscore dialog base names \(OVOS-INTENT-2 §2\) [\#71](https://github.com/OpenVoiceOS/ovos-skill-diagnostics/pull/71) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- feat: locale balance — en-US ca-ES da-DK de-DE es-ES eu-ES fr-FR gl-ES it-IT kab nl-NL oc-FR pt-BR pt-PT sv-SE [\#66](https://github.com/OpenVoiceOS/ovos-skill-diagnostics/pull/66) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: tighten en-US intent definitions [\#47](https://github.com/OpenVoiceOS/ovos-skill-diagnostics/pull/47) ([JarbasAl](https://github.com/JarbasAl))
